...
function OtpMailAndVerification() {
    ...
    const handleSendOtp = async (e) => {
        ...
        try {
            await axios.post("http://busdejavu-backend.vercel.app/api/sendotp", data);
    ...
    const handleVerifyOtp = async (e) => {
        ...
        try {
            const response = await axios.post("http://busdejavu-backend.vercel.app/api/verifyotp", data);
